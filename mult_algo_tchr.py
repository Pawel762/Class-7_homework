# I took this code from https://github.com/cce-bigdataintro-1160/spring2019/tree/master/class7-homework
# The code fit my data so I didn't need to adjust it. I changed the color to have a greater contrast
# between the two lines. I also made f1 score dotted on the graph
...
# Splitting dataset
X_train, X_test, y_train, y_test = train_test_split(scaled_features, y, test_size=0.35, random_state=5)
...
# Plotting results
plt.plot(f1_scores, color='black', label='f1 score', linestyle='dotted')
plt.plot(error_rate, color='blue', label='error rate', linestyle='--')
